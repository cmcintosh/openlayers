  ...
  */
  loadMapObject: function() {
      var platform = new H.service.Platform({
        app_id: '8nFnSuCEKYWHJ2DrdOeu',
          app_code: 'ZzTdUf8ohJT_M1VAIxjdNQ',
          useCIT: true
      });
      var defaultLayers = platform.createDefaultLayers();


      // var map = new H.Map(document.getElementById('OpenLayers_Layer_Here_2_EventPane'), defaultLayers.normal.map);
      ...
      if (cache) {
        ...
        mapObject = new H.Map(document.getElementById('OpenLayers_Layer_Here_2_EventPane'), defaultLayers.normal.map);
      ...
      console.log("Check zoom " + this.mapObject.getZoom());

      console.log("Check zoom " + this.mapObject.getZoom());
      this.setHereMapVisibility(this.visibility);
      this.mapObject.zoomAt(5, 10, 10);

      document.getElementById("OpenLayers_Control_Zoom_7").innerHTML = "";
      var behavior = new H.mapevents.Behavior(new H.mapevents.MapEvents(this.mapObject));

      // Create the default UI components
      var ui = H.ui.UI.createDefault(this.mapObject, defaultLayers);
  ...
  */
  setHereMapVisibility: function(visible) {
    ...
    if (cache) {
      ...
      // We need to be able to dynamically change this
  ...
  */
  ...
  /**
    ...
    getMapObjectBoundsFromOLBounds: function(olBounds) {
        ...
        var hBounds = this.mapObject.getViewBounds();
